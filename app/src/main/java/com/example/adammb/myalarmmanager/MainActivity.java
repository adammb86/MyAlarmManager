package com.example.adammb.myalarmmanager;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button btnRepeatingTime, btnRepeating, btnCancelRepeatingAlarm;
        ...
        if(v.getId()==R.id.btn_one_time_alarm_date) {
            ...
            new TimePickerDialog(this, new TimePickerDialog.OnTimeSetListener() {
                ...
                public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                    ...
                    //Log.v(TAG, "The choosen one"+ currentDate.getTime());
                }
            ...
            SimpleDateFormat timeFormat=new SimpleDateFormat("HH:mm");
            String repeatTime=timeFormat.format(calRepeatTimeTime.getTime());
